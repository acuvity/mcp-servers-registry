...
**Latest tags:**
  - `latest` -> `1.0.0-1.0.20260112001` -> `1.0.20260112001`
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-graphlit:1.0.20260112001`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-graphlit:1.0.0-1.0.20260112001`
    ...
    "servers": {
      "acuvity-mcp-server-graphlit": {
        ...
        "args": [
          ...
          "-e",
          "GRAPHLIT_JWT_SECRET",
          "docker.io/acuvity/mcp-server-graphlit:1.0.20260112001"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","GRAPHLIT_ORGANIZATION_ID","-e","GRAPHLIT_ENVIRONMENT_ID","-e","GRAPHLIT_JWT_SECRET","docker.io/acuvity/mcp-server-graphlit:1.0.20260112001"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e GRAPHLIT_ORGANIZATION_ID -e GRAPHLIT_ENVIRONMENT_ID -e GRAPHLIT_JWT_SECRET docker.io/acuvity/mcp-server-graphlit:1.0.20260112001`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e GRAPHLIT_ORGANIZATION_ID -e GRAPHLIT_ENVIRONMENT_ID -e GRAPHLIT_JWT_SECRET docker.io/acuvity/mcp-server-graphlit:1.0.20260112001
```
