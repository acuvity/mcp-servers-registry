...
_cross_tool_exclude := [
	...
	"listAllHashes",
	#
	"getJsonSection_version",
	#
	"getJsonSection_title",
	#
	"getJsonSection_file_name",
	#
	"getJsonSection_app_name",
	#
	"getJsonSection_app_type",
	#
	"getJsonSection_size",
	#
	"getJsonSection_md5",
	...
	"getJsonSection_sha1",
	#
	"getJsonSection_sha256",
	#
	"getJsonSection_package_name",
	#
	"getJsonSection_main_activity",
	#
	"getJsonSection_exported_activities",
	#
	"getJsonSection_browsable_activities",
	#
	"getJsonSection_activities",
	#
	"getJsonSection_receivers",
	#
	"getJsonSection_providers",
	#
	"getJsonSection_services",
	#
	"getJsonSection_libraries",
	#
	"getJsonSection_target_sdk",
	#
	"getJsonSection_max_sdk",
	#
	"getJsonSection_min_sdk",
	#
	"getJsonSection_version_name",
	#
	"getJsonSection_version_code",
	#
	"getJsonSection_permissions",
	#
	"getJsonSection_malware_permissions",
	#
	"getJsonSection_certificate_analysis",
	#
	"getJsonSection_manifest_analysis",
	#
	"getJsonSection_network_security",
	#
	"getJsonSection_binary_analysis",
	#
	"getJsonSection_file_analysis",
	#
	"getJsonSection_android_api",
	#
	"getJsonSection_code_analysis",
	#
	"getJsonSection_niap_analysis",
	#
	"getJsonSection_permission_mapping",
	#
	"getJsonSection_urls",
	#
	"getJsonSection_domains",
	#
	"getJsonSection_emails",
	#
	"getJsonSection_strings",
	#
	"getJsonSection_firebase_urls",
	#
	"getJsonSection_exported_count",
	#
	"getJsonSection_apkid",
	#
	"getJsonSection_behaviour",
	#
	"getJsonSection_trackers",
	#
	"getJsonSection_playstore_details",
	#
	"getJsonSection_secrets",
	#
	"getJsonSection_logs",
	#
	"getJsonSection_sbom",
	#
	"getJsonSection_average_cvss",
	#
	"getJsonSection_appsec",
	#
	"getJsonSection_virus_total",
	#
	"getJsonSection_base_url",
	#
	"getJsonSection_dwd_dir",
	#
	"getJsonSection_host_os",
	#
