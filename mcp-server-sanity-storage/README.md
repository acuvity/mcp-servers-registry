...
See full charts [Readme](https://github.com/acuvity/mcp-servers-registry/mcp-server-sanity-storage/charts/mcp-server-sanity-storage/README.md) for more details about settings.
