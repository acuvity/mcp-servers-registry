...
> [!NOTE]
> `mcp-server-shopify-dev` has been packaged by Acuvity from @shopify/dev-mcp original [sources](https://github.com/Shopify/dev-mcp).
    ...
    "servers": {
      "acuvity-mcp-server-shopify-dev": {
        ...
        "args": [
          ...
          "--rm",
          "--read-only",
          "docker.io/acuvity/mcp-server-shopify-dev:1.0.2"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","docker.io/acuvity/mcp-server-shopify-dev:1.0.2"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only docker.io/acuvity/mcp-server-shopify-dev:1.0.2`
...
```console
docker run -i --rm --read-only docker.io/acuvity/mcp-server-shopify-dev:1.0.2
```
