...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-grafana:v0.4.2`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-grafana:1.0.0-v0.4.2`
    ...
    "servers": {
      "acuvity-mcp-server-grafana": {
        ...
        "args": [
          ...
          "-e",
          "GRAFANA_URL",
          "docker.io/acuvity/mcp-server-grafana:v0.4.2"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","GRAFANA_API_KEY","-e","GRAFANA_URL","docker.io/acuvity/mcp-server-grafana:v0.4.2"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e GRAFANA_API_KEY -e GRAFANA_URL docker.io/acuvity/mcp-server-grafana:v0.4.2`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e GRAFANA_API_KEY -e GRAFANA_URL docker.io/acuvity/mcp-server-grafana:v0.4.2
```
