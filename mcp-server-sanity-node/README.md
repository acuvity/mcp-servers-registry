...
See full charts [Readme](https://github.com/acuvity/mcp-servers-registry/mcp-server-sanity-node/charts/mcp-server-sanity-node/README.md) for more details about settings.
