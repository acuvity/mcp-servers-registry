...
See full charts [Readme](https://github.com/acuvity/mcp-servers-registry/mcp-server-sanity-python/charts/mcp-server-sanity-python/README.md) for more details about settings.
