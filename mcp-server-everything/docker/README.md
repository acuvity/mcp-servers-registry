...
> [!NOTE]
> `mcp-server-everything` has been packaged by Acuvity from @modelcontextprotocol/server-everything original [sources](https://modelcontextprotocol.io).
    ...
    "servers": {
      "acuvity-mcp-server-everything": {
        ...
        "args": [
          ...
          "--rm",
          "--read-only",
          "docker.io/acuvity/mcp-server-everything:2025.4.28"
        ]
      }
    }
  }
