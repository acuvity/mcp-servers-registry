...
> [!NOTE]
> `mcp-server-aws-lambda` has been packaged by Acuvity from awslabs.lambda-mcp-server original [sources](https://github.com/awslabs/mcp/tree/main/src/lambda-mcp-server).
