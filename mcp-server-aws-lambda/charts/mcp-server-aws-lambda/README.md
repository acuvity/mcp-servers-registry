...
**Description:** An AWS Labs Model Context Protocol (MCP) server for AWS Lambda
...
```console
helm install helm install mcp-server-aws-lambda oci://docker.io/acuvity/mcp-server-aws-lambda --version 1.0.0
```
