...
[![Docker](https://img.shields.io/docker/image-size/acuvity/mcp-server-figma/0.6.4?logo=docker&logoColor=fff&label=0.6.4)](https://hub.docker.com/r/acuvity/mcp-server-figma)
[![PyPI](https://img.shields.io/badge/0.6.4-3775A9?logo=pypi&logoColor=fff&label=figma-developer-mcp)](https://github.com/GLips/Figma-Context-MCP)
...
[![Install in VS Code Docker](https://img.shields.io/badge/VS_Code-One_click_install-0078d7?logo=githubcopilot)](https://insiders.vscode.dev/redirect/mcp/install?name=mcp-server-figma&config=%7B%22args%22%3A%5B%22run%22%2C%22-i%22%2C%22--rm%22%2C%22--read-only%22%2C%22-e%22%2C%22FIGMA_API_KEY%22%2C%22docker.io%2Facuvity%2Fmcp-server-figma%3A0.6.4%22%5D%2C%22command%22%3A%22docker%22%7D)
...
**Maintained by**:
  ...
  - [ Author ](https://github.com/GLips/Figma-Context-MCP) for application
...
**Resources**:
  - [Charts](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-figma/charts/mcp-server-figma)
  - [Dockerfile](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-figma/docker/Dockerfile)

**Current supported version:**
  - charts: `1.0.0`
  - container: `1.0.0-0.6.4`
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - container: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-figma:1.0.0-0.6.4`
...
```console
helm show chart oci://docker.io/acuvity/mcp-server-figma --version 1.0.0
````
...
```console
helm upgrade mcp-server-figma oci://docker.io/acuvity/mcp-server-figma --version 1.0.0
```

Uninstall with helm

```console
helm uninstall mcp-server-figma
```

From there your MCP server mcp-server-figma will be reachable by default through `http/sse` from inside the cluster using the Kubernetes Service `mcp-server-figma` on port `8000` by default.
...
```yaml
image:
  repository: map[host:docker.io org:acuvity]/mcp-server-figma
...
- **storage**: iterates `package.storage` entries:
  - for persistent entries, creates a PersistentVolumeClaim named `mcp-server-figma` with `storageClassName: <class>` and `resources.requests.storage: <size>`.
...
```console
helm upgrade mcp-server-figma oci://docker.io/acuvity/mcp-server-figma --version 1.0.0 --set 'minibridge.guardrails={secrets-redaction}'
```
...
```console
helm upgrade mcp-server-figma oci://docker.io/acuvity/mcp-server-figma --version 1.0.0 -f values.yaml
```

To enable basic auth:

```console
helm upgrade mcp-server-figma oci://docker.io/acuvity/mcp-server-figma --version 1.0.0 --set minibridge.basicAuth.value="supersecret"
```
...
| nodeId | string | The ID of the node to fetch, often found as URL parameter node-id=<nodeId>, always use if provided. Use format '1234:5678' or 'I5666:180910;1:10515;1:10336' for multiple nodes. | No
</details>
<details>
...
| Name | Type | Description | Required? |
|-----------|------|-------------|-----------|
| fileKey | string | The key of the Figma file containing the images | Yes
...
| tools | download_figma_images | fileKey | a32fa12ec77d0ff82572792755b113b134c989bdaea1a69d0a4302a969912a19 |
...
| tools | get_figma_data | description | a51af5366ba63f50a6f3e7ed6dbc2ca1a14411dba192590e04f0dea36153f8a1 |
| tools | get_figma_data | depth | 5678aa47771c7e0f5a3391cd3d7bc1a5cb71c20f25e41499cc4bc65924054672 |
| tools | get_figma_data | fileKey | 40c6b773426799bfacc6ce508e311fa5cddf0ab924212dc6d9114991b2379b1c |
| tools | get_figma_data | nodeId | d5b087f38d247ac5fe260cdace2a6dd087fe6345c0441f34748606fd50d75b26 |
