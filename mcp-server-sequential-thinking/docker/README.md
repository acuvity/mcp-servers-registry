...
> [!NOTE]
> `mcp-server-sequential-thinking` has been packaged by Acuvity from @modelcontextprotocol/server-sequential-thinking original [sources](https://modelcontextprotocol.io).
