...
> [!NOTE]
> `coincap-mcp` has been repackaged by Acuvity from Alex Andru original sources.
...
```console
helm install helm install mcp-server-coincap oci://docker.io/acuvity/mcp-server-coincap --version 1.0.0
```
