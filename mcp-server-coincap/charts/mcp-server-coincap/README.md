...
[![Scout](https://img.shields.io/badge/Active-3775A9?logo=docker&logoColor=fff&label=Scout)](https://hub.docker.com/r/acuvity/mcp-server-coincap/)
...
Packaged by Acuvity and published to our curated MCP server [registry](https://mcp.acuvity.ai) from coincap-mcp original [sources](https://github.com/QuantGeekDev/coincap-mcp).
...
**Maintained by**:
  ...
  - [ Alex Andru ](https://github.com/QuantGeekDev/coincap-mcp) for application

**Where to get help**:
  - [The Acuvity MCP Forge repository](https://github.com/acuvity/mcp-servers-registry)
  - [ coincap-mcp ](https://github.com/QuantGeekDev/coincap-mcp)
...
**Resources**:
  - [Charts](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-coincap/charts/mcp-server-coincap)
  - [Dockerfile](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-coincap/docker/Dockerfile)
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - charts: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-coincap:1.0.0`
  - container: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-coincap:1.0.0-0.9.3`
...
```console
helm show chart oci://docker.io/acuvity/mcp-server-coincap --version 1.0.0
````
...
```console
helm upgrade mcp-server-coincap oci://docker.io/acuvity/mcp-server-coincap --version 1.0.0
```

Uninstall with helm

```console
helm uninstall mcp-server-coincap
```

From there your MCP server mcp-server-coincap will be reachable by default through `http/sse` from inside the cluster using the Kubernetes Service `mcp-server-coincap` on port `8000` by default.
...
```yaml
image:
  repository: map[host:docker.io org:acuvity]/mcp-server-coincap
...
- **storage**: iterates `package.storage` entries:
  - for persistent entries, creates a PersistentVolumeClaim named `mcp-server-coincap` with `storageClassName: <class>` and `resources.requests.storage: <size>`.
...
```console
helm upgrade mcp-server-coincap oci://docker.io/acuvity/mcp-server-coincap --version 1.0.0 --set 'minibridge.guardrails={secrets-redaction}'
```
...
```console
helm upgrade mcp-server-coincap oci://docker.io/acuvity/mcp-server-coincap --version 1.0.0 -f values.yaml
```

To enable basic auth:

```console
helm upgrade mcp-server-coincap oci://docker.io/acuvity/mcp-server-coincap --version 1.0.0 --set minibridge.basicAuth.value="supersecret"
```
