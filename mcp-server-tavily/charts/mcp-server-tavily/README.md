...
[![Docker](https://img.shields.io/docker/image-size/acuvity/mcp-server-tavily/0.2.12?logo=docker&logoColor=fff&label=0.2.12)](https://hub.docker.com/r/acuvity/mcp-server-tavily)
[![PyPI](https://img.shields.io/badge/0.2.12-3775A9?logo=pypi&logoColor=fff&label=tavily-mcp)](https://github.com/tavily-ai/tavily-mcp)
...
The [ARC](https://github.com/acuvity/mcp-servers-registry/tree/main) container includes a [built-in Rego policy](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-tavily/docker/policy.rego) that enables a set of runtime [guardrails](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-tavily#%EF%B8%8F-guardrails) to help enforce security, privacy, and correct usage of your services. Below is list of each guardrail provided.
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - container: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-tavily:1.0.0-0.2.12`
...
|-----------|------|-------------|-----------|
| country | string | Boost search results from a specific country. This will prioritize content from the selected country in the search results. Available only if topic is general. Country names MUST be written in lowercase, plain English, with spaces and no underscores. | No
...
| end_date | string | Will return all results before the specified end date. Required to be written in the format YYYY-MM-DD | No
...
| include_favicon | boolean | Whether to include the favicon URL for each result | No
...
| search_depth | string | The depth of the search. 'basic' for generic results, 'advanced' for more thorough search, 'fast' for optimized low latency with high relevance, 'ultra-fast' for prioritizing latency above all else | No
| start_date | string | Will return all results after the specified start date. Required to be written in the format YYYY-MM-DD. | No
...
| query | string | User intent query for reranking extracted chunks based on relevance | No
...
| Name | Type | Description | Required? |
|-----------|------|-------------|-----------|
| allow_external | boolean | Whether to return external links in the final response | No
...
| format | string | The format of the extracted web page content. markdown returns content in markdown format. text returns plain text and may increase latency. | No
| include_favicon | boolean | Whether to include the favicon URL for each result | No
| instructions | string | Natural language instructions for the crawler. Instructions specify which types of pages the crawler should return. | No
...
| select_domains | array | Regex patterns to restrict crawling to specific domains or subdomains (e.g., ^docs\.example\.com$) | No
...
|-----------|------|------|------|
| tools | tavily-crawl | description | defbd252dc23ce8d5c3fc383e27f24834530b0529d636f8385a9549cc8e776ee |
| tools | tavily-crawl | allow_external | 6d75ab85c88c58d7bb8aa2526aa1db4d354d41c42174c99e17113361453a1640 |
...
| tools | tavily-crawl | include_favicon | b652bf267458a9d9c24e32033e19dcff838e590585fc0fdc1a6cc4a0fead39a7 |
| tools | tavily-crawl | instructions | 6e264919d7101d597e2592ea863e7ea76fd2d53f6acc5357b0836053d09259a8 |
...
| tools | tavily-crawl | select_domains | 0a3eaa25fb9564a45bd049e7de92d72490fcf31706ba09fd57af459e83503bda |
...
| tools | tavily-extract | include_favicon | b652bf267458a9d9c24e32033e19dcff838e590585fc0fdc1a6cc4a0fead39a7 |
| tools | tavily-extract | include_images | ad583d5fbb5404a91cb49e4192e39a9d26339fb5d68afceb0fc5e15654981bda |
| tools | tavily-extract | query | 5b2c08aceb7c269568d55180e0b13d3c15e4e7495163207f2e84bf36f5f264bc |
...
| tools | tavily-map | allow_external | 6d75ab85c88c58d7bb8aa2526aa1db4d354d41c42174c99e17113361453a1640 |
...
| tools | tavily-map | select_domains | 0a3eaa25fb9564a45bd049e7de92d72490fcf31706ba09fd57af459e83503bda |
...
| tools | tavily-search | country | 29c84250505356cc89e177cfa84a81d5d31a0d92c1b0d991085925bf2331dc02 |
| tools | tavily-search | days | a5166a9dc7b62d6c568b6a86b91e09c679a6fa43d83f2a3178abc5e398f37d22 |
| tools | tavily-search | end_date | d52e5a37192f7f0f0150fd7bf3a63f93956e88376dec674dbed8e044d5c8af55 |
...
| tools | tavily-search | include_favicon | b652bf267458a9d9c24e32033e19dcff838e590585fc0fdc1a6cc4a0fead39a7 |
...
| tools | tavily-search | search_depth | 16724ca1a6a17925fc4def2336418371af499797c0459cf4234dadb1182b8dc5 |
| tools | tavily-search | start_date | e8e7fa7abc663eb2f6daf1e9294bdb837162a847508d54777e0fd1ace7437039 |
