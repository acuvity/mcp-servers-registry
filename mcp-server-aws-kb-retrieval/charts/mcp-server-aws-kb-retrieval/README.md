...
> [!NOTE]
> `mcp-server-aws-kb-retrieval` has been packaged by Acuvity from @modelcontextprotocol/server-aws-kb-retrieval original [sources](https://modelcontextprotocol.io).
