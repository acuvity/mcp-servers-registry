...
> [!NOTE]
> `mcp-server-apple-shortcuts` has been packaged by Acuvity from mcp-server-apple-shortcuts original [sources](https://github.com/recursechat/mcp-server-apple-shortcuts).
