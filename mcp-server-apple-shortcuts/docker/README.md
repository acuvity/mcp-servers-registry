...
See full charts [Readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-apple-shortcuts/charts/mcp-server-apple-shortcuts/README.md) for more details about settings.
