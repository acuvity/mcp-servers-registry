...
> [!NOTE]
> `attio-mcp-server` has been repackaged by Acuvity from @hmk original sources.
...
```console
helm install helm install mcp-server-attio oci://docker.io/acuvity/mcp-server-attio --version 1.0.0
```
