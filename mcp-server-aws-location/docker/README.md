...
[![Docker](https://img.shields.io/docker/image-size/acuvity/mcp-server-aws-location/2.0.13?logo=docker&logoColor=fff&label=2.0.13)](https://hub.docker.com/r/acuvity/mcp-server-aws-location)
[![PyPI](https://img.shields.io/badge/2.0.13-3775A9?logo=pypi&logoColor=fff&label=awslabs.aws-location-mcp-server)](https://github.com/awslabs/mcp/tree/HEAD/src/aws-location-mcp-server)
...
The [ARC](https://github.com/acuvity/mcp-servers-registry/tree/main) container includes a [built-in Rego policy](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-location/docker/policy.rego) that enables a set of runtime [guardrails](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-location#%EF%B8%8F-guardrails) to help enforce security, privacy, and correct usage of your services. Below is list of each guardrail provided.
...
**Maintained by**:
  ...
  - [ AWSLabs MCP <203918161+awslabs-mcp@users.noreply.github.com> ](https://github.com/awslabs/mcp/tree/HEAD/src/aws-location-mcp-server) for original source application
...
**Latest tags:**
  - `latest` -> `1.0.0-2.0.13` -> `2.0.13`
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-aws-location/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-location:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-location:2.0.13`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-location:1.0.0-2.0.13`
    ...
    "servers": {
      "acuvity-mcp-server-aws-location": {
        ...
        "args": [
          ...
          "--rm",
          "--read-only",
          "docker.io/acuvity/mcp-server-aws-location:2.0.13"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","docker.io/acuvity/mcp-server-aws-location:2.0.13"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only docker.io/acuvity/mcp-server-aws-location:2.0.13`
...
```console
docker run -it -p 8000:8000 --rm --read-only docker.io/acuvity/mcp-server-aws-location:2.0.13
```
...
For detailed list of all features, tools, arguments and SBOM hashes provided by this server please consult the [readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-location)
