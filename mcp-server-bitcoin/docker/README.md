...
> [!NOTE]
> `mcp-server-bitcoin` has been packaged by Acuvity from bitcoin-mcp original [sources](https://github.com/AbdelStark/bitcoin-mcp).
...
```console
docker run -i --rm --read-only docker.io/acuvity/mcp-server-bitcoin:0.0.6
```
