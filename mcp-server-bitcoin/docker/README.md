...
See full charts [Readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-bitcoin/charts/mcp-server-bitcoin/README.md) for more details about settings.
