...
**Latest tags:**
  - `latest` -> `1.0.0-0.1.34` -> `0.1.34`
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-doit/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-doit:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-doit:0.1.34`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-doit:1.0.0-0.1.34`
    ...
    "servers": {
      "acuvity-mcp-server-doit": {
        ...
        "args": [
          ...
          "-e",
          "DOIT_API_KEY",
          "docker.io/acuvity/mcp-server-doit:0.1.34"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","DOIT_API_KEY","docker.io/acuvity/mcp-server-doit:0.1.34"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e DOIT_API_KEY docker.io/acuvity/mcp-server-doit:0.1.34`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e DOIT_API_KEY docker.io/acuvity/mcp-server-doit:0.1.34
```
