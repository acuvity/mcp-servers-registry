...
[![Docker](https://img.shields.io/docker/image-size/acuvity/mcp-server-anilist/1.4.0?logo=docker&logoColor=fff&label=1.4.0)](https://hub.docker.com/r/acuvity/mcp-server-anilist)
[![PyPI](https://img.shields.io/badge/1.4.0-3775A9?logo=pypi&logoColor=fff&label=anilist-mcp)](https://github.com/yuna0x0/anilist-mcp)
...
[![Install in VS Code Docker](https://img.shields.io/badge/VS_Code-One_click_install-0078d7?logo=githubcopilot)](https://insiders.vscode.dev/redirect/mcp/install?name=mcp-server-anilist&config=%7B%22args%22%3A%5B%22run%22%2C%22-i%22%2C%22--rm%22%2C%22--read-only%22%2C%22-e%22%2C%22ANILIST_TOKEN%22%2C%22docker.io%2Facuvity%2Fmcp-server-anilist%3A1.4.0%22%5D%2C%22command%22%3A%22docker%22%7D)
...
The [ARC](https://github.com/acuvity/mcp-servers-registry/tree/main) container includes a [built-in Rego policy](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-anilist/docker/policy.rego) that enables a set of runtime [guardrails](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-anilist#%EF%B8%8F-guardrails) to help enforce security, privacy, and correct usage of your services. Below is list of each guardrail provided.
...
**Maintained by**:
  ...
  - [ yuna0x0 ](https://github.com/yuna0x0/anilist-mcp) for original source application
...
**Latest tags:**
  - `latest` -> `1.0.0-1.4.0` -> `1.4.0`
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-anilist/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-anilist:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-anilist:1.4.0`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-anilist:1.0.0-1.4.0`
    ...
    "servers": {
      "acuvity-mcp-server-anilist": {
        ...
        "args": [
          ...
          "-e",
          "ANILIST_TOKEN",
          "docker.io/acuvity/mcp-server-anilist:1.4.0"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","ANILIST_TOKEN","docker.io/acuvity/mcp-server-anilist:1.4.0"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e ANILIST_TOKEN docker.io/acuvity/mcp-server-anilist:1.4.0`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e ANILIST_TOKEN docker.io/acuvity/mcp-server-anilist:1.4.0
```
...
For detailed list of all features, tools, arguments and SBOM hashes provided by this server please consult the [readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-anilist)
