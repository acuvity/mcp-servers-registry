...
> [!NOTE]
> `mcp-server-git` has been packaged by Acuvity from mcp-server-git original [sources](https://github.com/modelcontextprotocol/servers/tree/main/src/git).
...
```console
docker run -i --rm --read-only docker.io/acuvity/mcp-server-git:2025.1.14
```
