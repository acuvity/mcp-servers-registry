...
**Maintained by**:
  ...
  - [ Author ](https://github.com/neo4j-contrib/mcp-neo4j/tree/HEAD/servers/mcp-neo4j-cypher) for original source application
...
**Latest tags:**
  - `latest` -> `1.0.0-0.5.2` -> `0.5.2`
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-neo4j-cypher/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-neo4j-cypher:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-neo4j-cypher:0.5.2`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-neo4j-cypher:1.0.0-0.5.2`
    ...
    "servers": {
      "acuvity-mcp-server-neo4j-cypher": {
        ...
        "args": [
          ...
          "-e",
          "NEO4J_USERNAME",
          "docker.io/acuvity/mcp-server-neo4j-cypher:0.5.2"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","NEO4J_DATABASE","-e","NEO4J_PASSWORD","-e","NEO4J_URI","-e","NEO4J_USERNAME","docker.io/acuvity/mcp-server-neo4j-cypher:0.5.2"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e NEO4J_DATABASE -e NEO4J_PASSWORD -e NEO4J_URI -e NEO4J_USERNAME docker.io/acuvity/mcp-server-neo4j-cypher:0.5.2`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e NEO4J_DATABASE -e NEO4J_PASSWORD -e NEO4J_URI -e NEO4J_USERNAME docker.io/acuvity/mcp-server-neo4j-cypher:0.5.2
```
...
For detailed list of all features, tools, arguments and SBOM hashes provided by this server please consult the [readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-neo4j-cypher)
