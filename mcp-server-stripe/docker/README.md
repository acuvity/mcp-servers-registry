...
**Maintained by**:
  ...
  - [ Stripe ](https://github.com/stripe/agent-toolkit) for original source application
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-stripe:0.2.5`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-stripe:1.0.0-0.2.5`
    ...
    "servers": {
      "acuvity-mcp-server-stripe": {
        ...
        "args": [
          ...
          "-e",
          "STRIPE_SECRET_KEY",
          "docker.io/acuvity/mcp-server-stripe:0.2.5"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","STRIPE_SECRET_KEY","docker.io/acuvity/mcp-server-stripe:0.2.5"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e STRIPE_SECRET_KEY docker.io/acuvity/mcp-server-stripe:0.2.5`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e STRIPE_SECRET_KEY docker.io/acuvity/mcp-server-stripe:0.2.5
```
