...
**Maintained by**:
  ...
  - [ AWSLabs MCP <203918161+awslabs-mcp@users.noreply.github.com>, Jimin Kim <jimini55@users.noreply.github.com> ](https://github.com/awslabs/mcp/tree/HEAD/src/code-doc-gen-mcp-server) for original source application
...
**Latest tags:**
  - `latest` -> `1.0.0-1.0.9` -> `1.0.9`
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-aws-code-documentation/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-code-documentation:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-code-documentation:1.0.9`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-code-documentation:1.0.0-1.0.9`
    ...
    "servers": {
      "acuvity-mcp-server-aws-code-documentation": {
        ...
        "args": [
          ...
          "-v",
          "data:/data",
          "docker.io/acuvity/mcp-server-aws-code-documentation:1.0.9"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-v","data:/data","docker.io/acuvity/mcp-server-aws-code-documentation:1.0.9"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -v data:/data docker.io/acuvity/mcp-server-aws-code-documentation:1.0.9`
...
```console
docker run -it -p 8000:8000 --rm --read-only -v data:/data docker.io/acuvity/mcp-server-aws-code-documentation:1.0.9
```
...
For detailed list of all features, tools, arguments and SBOM hashes provided by this server please consult the [readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-code-documentation)
