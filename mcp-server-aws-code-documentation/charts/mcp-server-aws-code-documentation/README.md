...
[![Docker](https://img.shields.io/docker/image-size/acuvity/mcp-server-aws-code-documentation/1.0.9?logo=docker&logoColor=fff&label=1.0.9)](https://hub.docker.com/r/acuvity/mcp-server-aws-code-documentation)
[![PyPI](https://img.shields.io/badge/1.0.9-3775A9?logo=pypi&logoColor=fff&label=awslabs.code-doc-gen-mcp-server)](https://github.com/awslabs/mcp/tree/HEAD/src/code-doc-gen-mcp-server)
...
[![Install in VS Code Docker](https://img.shields.io/badge/VS_Code-One_click_install-0078d7?logo=githubcopilot)](https://insiders.vscode.dev/redirect/mcp/install?name=mcp-server-aws-code-documentation&config=%7B%22args%22%3A%5B%22run%22%2C%22-i%22%2C%22--rm%22%2C%22--read-only%22%2C%22-v%22%2C%22data%3A%2Fdata%22%2C%22docker.io%2Facuvity%2Fmcp-server-aws-code-documentation%3A1.0.9%22%5D%2C%22command%22%3A%22docker%22%7D)
...
The [ARC](https://github.com/acuvity/mcp-servers-registry/tree/main) container includes a [built-in Rego policy](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-code-documentation/docker/policy.rego) that enables a set of runtime [guardrails](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-code-documentation#%EF%B8%8F-guardrails) to help enforce security, privacy, and correct usage of your services. Below is list of each guardrail provided.
...
**Maintained by**:
  ...
  - [ AWSLabs MCP <203918161+awslabs-mcp@users.noreply.github.com>, Jimin Kim <jimini55@users.noreply.github.com> ](https://github.com/awslabs/mcp/tree/HEAD/src/code-doc-gen-mcp-server) for application

**Where to get help**:
  - [The Acuvity MCP Forge repository](https://github.com/acuvity/mcp-servers-registry)
  - [ awslabs.code-doc-gen-mcp-server ](https://github.com/awslabs/mcp/tree/HEAD/src/code-doc-gen-mcp-server)
...
**Resources**:
  - [Charts](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-code-documentation/charts/mcp-server-aws-code-documentation)
  - [Dockerfile](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-aws-code-documentation/docker/Dockerfile)
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - charts: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-code-documentation:1.0.0`
  - container: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-aws-code-documentation:1.0.0-1.0.9`
...
```console
helm show chart oci://docker.io/acuvity/mcp-server-aws-code-documentation --version 1.0.0
````
...
```console
helm upgrade mcp-server-aws-code-documentation oci://docker.io/acuvity/mcp-server-aws-code-documentation --version 1.0.0
```

Uninstall with helm

```console
helm uninstall mcp-server-aws-code-documentation
```

From there your MCP server mcp-server-aws-code-documentation will be reachable by default through `http/sse` from inside the cluster using the Kubernetes Service `mcp-server-aws-code-documentation` on port `8000` by default.
...
```yaml
image:
  repository: map[host:docker.io org:acuvity]/mcp-server-aws-code-documentation
...
- **storage**: iterates `package.storage` entries:
  - for persistent entries, creates a PersistentVolumeClaim named `mcp-server-aws-code-documentation` with `storageClassName: <class>` and `resources.requests.storage: <size>`.
...
```console
helm upgrade mcp-server-aws-code-documentation oci://docker.io/acuvity/mcp-server-aws-code-documentation --version 1.0.0 --set 'minibridge.guardrails={secrets-redaction}'
```
...
```console
helm upgrade mcp-server-aws-code-documentation oci://docker.io/acuvity/mcp-server-aws-code-documentation --version 1.0.0 -f values.yaml
```

To enable basic auth:

```console
helm upgrade mcp-server-aws-code-documentation oci://docker.io/acuvity/mcp-server-aws-code-documentation --version 1.0.0 --set minibridge.basicAuth.value="supersecret"
```
...
|-----------|------|------|------|
| tools | create_context | description | e2d52a92ea993a796a9339f917a0992f0295c848c1bdf8420ad6ed8235589ac6 |
| tools | create_context | analysis | ccb564b5c11106f0f375e81db01dd98b4bbfb37c6839aebf3e71e13c10db235d |
| tools | create_context | project_root | 2549d713cae9151b32ed49b6dffcfdc8a395b9371d8b5415dc2a08340306a974 |
| tools | generate_documentation | description | c8f8eee55fef1789f364ab79160e71956a03c1c724751e61f67bf5d7c8a5167e |
| tools | plan_documentation | description | 73f35f61c3afa458497225f76d6fb3c5a4c1b208d192ff989c3e8fde9fc346dc |
| tools | prepare_repository | description | b05fac0a593cea4156b4dacecbe92b1b118ca8fad5df1913e2339cb3427b59cf |
| tools | prepare_repository | project_root | 2549d713cae9151b32ed49b6dffcfdc8a395b9371d8b5415dc2a08340306a974 |
