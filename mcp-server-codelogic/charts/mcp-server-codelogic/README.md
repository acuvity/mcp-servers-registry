...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - container: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-codelogic:1.0.0-1.0.11`
...
```console
helm upgrade mcp-server-codelogic oci://docker.io/acuvity/mcp-server-codelogic --version 1.0.0
```

Uninstall with helm

```console
helm uninstall mcp-server-codelogic
```
...
```console
helm upgrade mcp-server-codelogic oci://docker.io/acuvity/mcp-server-codelogic --version 1.0.0 --set 'minibridge.guardrails={secrets-redaction}'
```
...
```console
helm upgrade mcp-server-codelogic oci://docker.io/acuvity/mcp-server-codelogic --version 1.0.0 -f values.yaml
```

To enable basic auth:

```console
helm upgrade mcp-server-codelogic oci://docker.io/acuvity/mcp-server-codelogic --version 1.0.0 --set minibridge.basicAuth.value="supersecret"
```
