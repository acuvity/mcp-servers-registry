...
To review the full policy, see it [here](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-fetch/docker/policy.rego). Alternatively, you can override the default policy or supply your own policy file to use (see [here](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-fetch/docker/entrypoint.sh) for Docker, [here](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-fetch/charts/mcp-server-fetch#minibridge) for Helm charts).
...
```console
helm upgrade mcp-server-fetch oci://docker.io/acuvity/mcp-server-fetch --version 1.0.0
```

Uninstall with helm

```console
helm uninstall mcp-server-fetch
```
...
```console
helm upgrade mcp-server-fetch oci://docker.io/acuvity/mcp-server-fetch --version 1.0.0 --set 'minibridge.guardrails={secrets-redaction}'
```
...
```console
helm upgrade mcp-server-fetch oci://docker.io/acuvity/mcp-server-fetch --version 1.0.0 -f values.yaml
```

To enable basic auth:

```console
helm upgrade mcp-server-fetch oci://docker.io/acuvity/mcp-server-fetch --version 1.0.0 --set minibridge.basicAuth.value="supersecret"
```
