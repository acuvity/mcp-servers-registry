...
**Maintained by**:
  ...
  - [ Author ](https://github.com/chroma-core/chroma-mcp) for original source application
...
**Latest tags:**
  ...
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-chroma/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-chroma:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-chroma:0.2.4`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-chroma:1.0.0-0.2.4`
    ...
    "servers": {
      "acuvity-mcp-server-chroma": {
        ...
        "args": [
          ...
          "-e",
          "CHROMA_TENANT",
          "docker.io/acuvity/mcp-server-chroma:0.2.4"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","CHROMA_CLIENT_TYPE","-e","CHROMA_DATABASE","-e","CHROMA_HOST","-e","CHROMA_PORT","-e","CHROMA_TENANT","docker.io/acuvity/mcp-server-chroma:0.2.4"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e CHROMA_CLIENT_TYPE -e CHROMA_DATABASE -e CHROMA_HOST -e CHROMA_PORT -e CHROMA_TENANT docker.io/acuvity/mcp-server-chroma:0.2.4`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e CHROMA_CLIENT_TYPE -e CHROMA_DATABASE -e CHROMA_HOST -e CHROMA_PORT -e CHROMA_TENANT docker.io/acuvity/mcp-server-chroma:0.2.4
```
...
For detailed list of all features, tools, arguments and SBOM hashes provided by this server please consult the [readme](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-chroma)
