...
[ -z "$API_TOKEN" ] && echo "!!! Error mcp-server-brightdata requires API_TOKEN env var to be set." && exit 1
[ -z "$BROWSER_AUTH" ] && echo "!!! Error mcp-server-brightdata requires BROWSER_AUTH env var to be set." && exit 1
