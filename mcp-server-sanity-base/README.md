...
See full charts [Readme](https://github.com/acuvity/mcp-servers-registry/mcp-server-sanity-base/charts/mcp-server-sanity-base/README.md) for more details about settings.
