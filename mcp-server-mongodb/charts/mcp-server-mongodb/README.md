...
[![Docker](https://img.shields.io/docker/image-size/acuvity/mcp-server-mongodb/1.5.0?logo=docker&logoColor=fff&label=1.5.0)](https://hub.docker.com/r/acuvity/mcp-server-mongodb)
[![PyPI](https://img.shields.io/badge/1.5.0-3775A9?logo=pypi&logoColor=fff&label=mongodb-mcp-server)](https://github.com/mongodb-js/mongodb-mcp-server)
...
[![Install in VS Code Docker](https://img.shields.io/badge/VS_Code-One_click_install-0078d7?logo=githubcopilot)](https://insiders.vscode.dev/redirect/mcp/install?name=mcp-server-mongodb&config=%7B%22args%22%3A%5B%22run%22%2C%22-i%22%2C%22--rm%22%2C%22--read-only%22%2C%22--tmpfs%22%2C%22%2Ftmp%3Arw%2Cnosuid%2Cnodev%22%2C%22docker.io%2Facuvity%2Fmcp-server-mongodb%3A1.5.0%22%5D%2C%22command%22%3A%22docker%22%7D)
...
The [ARC](https://github.com/acuvity/mcp-servers-registry/tree/main) container includes a [built-in Rego policy](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-mongodb/docker/policy.rego) that enables a set of runtime [guardrails](https://github.com/acuvity/mcp-servers-registry/tree/main/mcp-server-mongodb#%EF%B8%8F-guardrails) to help enforce security, privacy, and correct usage of your services. Below is list of each guardrail provided.
...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - container: `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-mongodb:1.0.0-1.5.0`
...
| responseBytesLimit | number | The maximum number of bytes to return in the response. This value is capped by the server's configured maxBytesPerQuery and cannot be exceeded. Note to LLM: If the entire aggregation result is required, use the "export" tool instead of increasing this limit. | No
</details>
<details>
...
| collection | string | Collection name | Yes
| database | string | Database name | Yes
| responseBytesLimit | number | The maximum number of bytes to return in the response. This value is capped by the server's configured maxBytesPerQuery and cannot be exceeded. | No
| sampleSize | number | Number of documents to sample for schema inference | No
</details>
<details>
...
| collection | string | Collection name | Yes
| database | string | Database name | Yes
| query | object | A filter/query parameter. Allows users to filter the documents to count. Matches the syntax of the filter argument of db.collection.count(). | No
</details>
<details>
...
| collection | string | Collection name | Yes
| database | string | Database name | Yes
| definition | array | The index definition. Use 'classic' for standard indexes. | Yes
...
| collection | string | Collection name | Yes
| database | string | Database name | Yes
| indexName | string | The name of the index to be dropped. | Yes
| type | string | The type of index to be deleted. Is always set to 'classic'. | No
</details>
<details>
...
| verbosity | string | The verbosity of the explain plan, defaults to queryPlanner. If the user wants to know how fast is a query in execution time, use executionStats. It supports all verbosities as defined in the MongoDB Driver. | No
</details>
<details>
...
| collection | string | Collection name | Yes
| database | string | Database name | Yes
| exportTarget | array | The export target along with its arguments. | Yes
| exportTitle | string | A short description to uniquely identify the export. | Yes
| jsonExportFormat | string | The format to be used when exporting collection data as EJSON with default being relaxed.
...
canonical: A string format that emphasizes type preservation at the expense of readability and interoperability. That is, conversion from canonical to BSON will generally preserve type information except in certain specific cases. | No
</details>
<details>
...
| responseBytesLimit | number | The maximum number of bytes to return in the response. This value is capped by the server's configured maxBytesPerQuery and cannot be exceeded. Note to LLM: If the entire query result is required, use the "export" tool instead of increasing this limit. | No
| sort | object | A document, describing the sort order, matching the syntax of the sort argument of cursor.sort(). The keys of the object are the fields to sort on, while the values are the sort directions (1 for ascending, -1 for descending). | No
</details>
<details>
...
| connectionType | string | Type of connection (standard, private, or privateEndpoint) to an Atlas cluster | No
...
| password | any | Password for the new user. IMPORTANT: If the user hasn't supplied an explicit password, leave it unset and under no circumstances try to generate a random one. A secure password will be generated by the MCP server if necessary. | No
| projectId | string | Atlas project ID | Yes
...
<details>
<summary>atlas-get-performance-advisor</summary>
...
| Name | Type | Description | Required? |
|-----------|------|-------------|-----------|
| clusterName | string | Atlas cluster name to get performance advisor recommendations | Yes
| namespaces | array | Namespaces to get slow query logs. Only relevant for the slowQueryLogs operation. | No
| operations | array | Operations to get performance advisor recommendations | No
| projectId | string | Atlas project ID to get performance advisor recommendations. The project ID is a hexadecimal identifier of 24 characters. If the user has only specified the name, use the `atlas-list-projects` tool to retrieve the user's projects with their ids. | Yes
| since | string | Date to get slow query logs since. Must be a string in ISO 8601 format. Only relevant for the slowQueryLogs operation. | No
</details>
<details>
...
<details>
<summary>atlas-list-alerts</summary>
...
| Name | Type | Description | Required? |
|-----------|------|-------------|-----------|
| projectId | string | Atlas project ID to list alerts for | Yes
</details>
<details>
...
| Name | Type | Description | Required? |
|-----------|------|-------------|-----------|
| orgId | string | Atlas organization ID to filter projects. If not provided, projects for all orgs are returned. | No
</details>
...
| tools | aggregate | pipeline | a0e171843950c46fa182f233723ca7bb184c82d47b7c5e5d609e199dc6958b97 |
| tools | aggregate | responseBytesLimit | dc171e11d1661dec2496910e7ff273b95c71be16b7c342ac7f70ab1b221d1c8f |
...
| tools | atlas-connect-cluster | connectionType | 7fa72b84a9077db82f2a68f740b98d7613e59de376b48d26619162dea2011d0a |
...
| tools | atlas-create-db-user | password | c3b7e9068d587600d2228c2aa4ae35ea49ea3fba8e399b99c65e2d62f4e58d6a |
...
| tools | atlas-get-performance-advisor | description | dd39b8abf9368c87e558aa1dcbb63f8610acea19fd909a45ba945413a0443a43 |
| tools | atlas-get-performance-advisor | clusterName | 9dd33c3d745a0f13546e74260e9a6566971568e09055b50cff8eef6323b347db |
| tools | atlas-get-performance-advisor | namespaces | 499fceb9868da76fb7e302dc97276366b3526fb63d6ad2adc8db11deb2a552cb |
| tools | atlas-get-performance-advisor | operations | 2d22c77dce2140831315519b65c412c3798c5ef0502b7c82cff1115c27d9880e |
| tools | atlas-get-performance-advisor | projectId | 82dfac2d630c50ab869c0f1b7fd801164c700ee2927d490fbd8b4598919ea5ad |
| tools | atlas-get-performance-advisor | since | 107315557cb2b1f587c1fc097fe122874ce002e496e3c08eb87e2097ac7363a8 |
...
| tools | atlas-inspect-cluster | description | abfcbd1eeb75b028f160d7445b8e016cd9ee4ab062db94230524fbdd566a1e12 |
...
| tools | atlas-list-alerts | description | 93f9e33d32f2de3499de9f88da9817816050d65a6c6beae00ba2c89e1e4e4cff |
| tools | atlas-list-alerts | projectId | 08b16ab91b7f140779aec8ff24057c06bed584e63392855734a1a12ee1cd60f4 |
...
| tools | atlas-list-projects | orgId | 9f17311081cfb68c67432789943671303448afc7203d57b2e6d9a02257ada8ad |
...
| tools | collection-schema | responseBytesLimit | a62ee5388f2dfb8c7edb4fb8bd48a14c7129ab9e1aa884d3067cf2afa6e487a9 |
| tools | collection-schema | sampleSize | b53f99cf856fd30a875694fd507e3cb08556bddf2768ee8dd1c71a022124ce49 |
...
| tools | connect | description | 46f35eaae3c9188944385d3f9ab0c1d3125c4170a9d87a9aa51d4fc423179e97 |
| tools | connect | connectionString | fd7eb15e287b7ff1b7aba3cf0ce4d3c9dfa9148c550733abe061f6bda209d664 |
| tools | count | description | 86aafe9bb89ecb2a662f12e354984fdbfe39e2980e18ae1870ec3cd49b3ae5d7 |
...
| tools | count | query | 8788932fc5225c7b3bbf1743a96680ee675914d7870d86128f08ac6659c2b794 |
...
| tools | create-index | definition | 1228c9ecac9facabede8d573c7ef985ad2e834a05bb2a7b0805c184c7729094e |
...
| tools | drop-index | description | b2c96684a1944bd5750afbdbf48200eaf423224053f2361b49d6162272dad9a4 |
| tools | drop-index | collection | 922214922b48f09e732a98c94e2f91391f0e4782749b280d909ee4d726492883 |
| tools | drop-index | database | e97a0773fb7b656c174155270bd9ded70bc82caa0fc5d65b3ba24871577a5b08 |
| tools | drop-index | indexName | 077502031c3a0946857a13029d60c77911b96096a2d0c595ffe3f143f1399b30 |
| tools | drop-index | type | 8f11c8d49efca3c9396a8f80d6741240b7e01a7a7472a3fc139e4d0b22034abc |
...
| tools | explain | verbosity | 4d80b100d9a7d0bc4f4e7bc50e4d59a9877a7df1dbe3cbe7bcd710c16081f763 |
| tools | export | description | 8db04659456a103eaa1fcecd5e0eaf9273047016e38721ce304bf8715ca1a1f9 |
| tools | export | collection | 922214922b48f09e732a98c94e2f91391f0e4782749b280d909ee4d726492883 |
| tools | export | database | e97a0773fb7b656c174155270bd9ded70bc82caa0fc5d65b3ba24871577a5b08 |
| tools | export | exportTarget | 37307174e6d8818cd77eed94896fb22cd96061e63b2ba1bb96ea444718dde36f |
| tools | export | exportTitle | eda59af8ae676459b04ec41f4d1db4edea02335b77fdfe56176631ad683d084a |
| tools | export | jsonExportFormat | 784dca89455bc4c7381a7668168b716229e27b4c8c27727694b9cea45c47b441 |
...
| tools | find | responseBytesLimit | b9c05a295251ed65d708c781d79ab40d442e4eed4a3adf76f26324032b1f6187 |
| tools | find | sort | 81f5b9fbb7727b212bf7d61b584bb8c7c8d4b05ec35b2fe6d7fb235a1fd58c3a |
| tools | insert-many | description | 90f41cfcd72b4124f5a97cf2545ce44250b1502e214474ffc874072fc887ed37 |
...
| tools | insert-many | documents | b50c1c1399bace35c0046900c77537c56da2ef3347c79491ebffed0d5755c55e |
...
| tools | update-many | description | bc7bada65c2c3a210432bd7b6190a638425adeba80895b8d553bdb20ddfe150e |
