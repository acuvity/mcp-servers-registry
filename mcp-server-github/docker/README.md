...
**Maintained by**:
  ...
  - [ github ](https://github.com/github/github-mcp-server) for original source application
...
**Latest tags:**
  - `latest` -> `1.0.0-v0.5.0` -> `v0.5.0`
  - [older tags](https://hub.docker.com/r/acuvity/mcp-server-github/tags)

**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-github:latest`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-github:v0.5.0`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-github:1.0.0-v0.5.0`
    ...
    "servers": {
      "acuvity-mcp-server-github": {
        ...
        "args": [
          ...
          "docker.io/acuvity/mcp-server-github:v0.5.0"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","-e","GITHUB_PERSONAL_ACCESS_TOKEN","docker.io/acuvity/mcp-server-github:v0.5.0"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only -e GITHUB_PERSONAL_ACCESS_TOKEN docker.io/acuvity/mcp-server-github:v0.5.0`
...
```console
docker run -it -p 8000:8000 --rm --read-only -e GITHUB_PERSONAL_ACCESS_TOKEN docker.io/acuvity/mcp-server-github:v0.5.0
```
