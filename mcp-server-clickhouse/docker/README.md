...
**Verify signature with [cosign](https://github.com/sigstore/cosign):**
  ...
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-clickhouse:0.1.13`
  - `cosign verify --certificate-oidc-issuer "https://token.actions.githubusercontent.com" --certificate-identity "https://github.com/acuvity/mcp-servers-registry/.github/workflows/release.yaml@refs/heads/main" docker.io/acuvity/mcp-server-clickhouse:1.0.0-0.1.13`
    ...
    "servers": {
      "acuvity-mcp-server-clickhouse": {
        ...
        "args": [
          ...
          "-e",
          "CLICKHOUSE_PASSWORD",
          "docker.io/acuvity/mcp-server-clickhouse:0.1.13"
        ]
      }
    }
  }
...
async with MCPServerStdio(
    params={
        ...
        "command": "docker",
        "args": ["run","-i","--rm","--read-only","--tmpfs","/tmp:rw,nosuid,nodev","-e","CLICKHOUSE_HOST","-e","CLICKHOUSE_USER","-e","CLICKHOUSE_PASSWORD","docker.io/acuvity/mcp-server-clickhouse:0.1.13"]
    }
) as server:
...
- command: `docker`
- arguments: `run -i --rm --read-only --tmpfs /tmp:rw,nosuid,nodev -e CLICKHOUSE_HOST -e CLICKHOUSE_USER -e CLICKHOUSE_PASSWORD docker.io/acuvity/mcp-server-clickhouse:0.1.13`
...
```console
docker run -it -p 8000:8000 --rm --read-only --tmpfs /tmp:rw,nosuid,nodev -e CLICKHOUSE_HOST -e CLICKHOUSE_USER -e CLICKHOUSE_PASSWORD docker.io/acuvity/mcp-server-clickhouse:0.1.13
```
